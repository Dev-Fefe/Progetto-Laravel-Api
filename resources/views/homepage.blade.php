         ...
         <section class="container">
            <div class="row justify-content-around align-items-center mt-4 pb-4">
                <div class="col-12 text-center mt-5 mb-3">
                    <h2>Miglior articoli.</h2>
                </div>
                <div class="col-12 col-md-5">
                    <!-- Swiper -->
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper h-img-custom">
                            <div class="swiper-slide"><img src="/media/3455.png" class="" alt=""></div>
                            <div class="swiper-slide"><img src="/media/bbabab55.png" class="" alt=""></div>
                            <div class="swiper-slide"><img src="/media/bsaba.png" class="" alt=""></div>
                        </div>
                ...
                <div class="col-12 col-md-5 text-center text-md-start">
                    <h5 class="fw-bold mt-4">Tutto</h5>
