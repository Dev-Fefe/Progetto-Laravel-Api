...
class ecommerceController extends Controller
{
    ...
    public function showArticles() {
        $articles = Http::get('https://fakestoreapi.com/products')->json();
        return view('articles', ['articles' => $articles]);
    }
    

    public function show($id) {
        $detail = Http::get('https://fakestoreapi.com/products/' . $id)->json();
        return view('articles-detail', ['detail' => $detail]);
    }
